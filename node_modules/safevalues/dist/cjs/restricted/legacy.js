...
exports.legacyUnsafeStyleSheet = exports.legacyUnsafeResourceUrl = exports.legacyUnsafeScript = exports.legacyUnsafeHtml = void 0;
...
function legacyUnsafeHtml(s) {
    ...
    return (0, html_impl_js_1.createHtmlInternal)(s);
}
...
function legacyUnsafeScript(s) {
    ...
    return (0, script_impl_js_1.createScriptInternal)(s);
}
...
function legacyUnsafeResourceUrl(s) {
    ...
    return (0, resource_url_impl_js_1.createResourceUrlInternal)(s);
}
...
function legacyUnsafeStyleSheet(s) {
    ...
    return (0, style_sheet_impl_js_1.createStyleSheetInternal)(s);
}
