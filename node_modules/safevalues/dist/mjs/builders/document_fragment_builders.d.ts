 ...
 */
export declare function htmlFragment(templateObj: TemplateStringsArray): DocumentFragment;
/**
 * Creates a DocumentFragment object from a template literal (without any
 ...
 * @param templateObj This contains the literal part of the template literal.
 */
export declare function svgFragment(templateObj: TemplateStringsArray): DocumentFragment;
/** Converts HTML markup into a node. */
export declare function htmlToNode(html: SafeHtml): Node;
