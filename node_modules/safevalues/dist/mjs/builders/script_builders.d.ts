...
declare type Serializable = Primitive | ReadonlyArray<Serializable | null> | {
 ...
 *     inline comments.
 */
export declare function safeScript(templateObj: TemplateStringsArray, ...emptyArgs: ReadonlyArray<''>): SafeScript;
 ...
 */
export declare function valueAsScript(value: Serializable | null): SafeScript;
/**
 * Creates a `SafeScript` object from a template literal (without any embedded
 ...
 *     inline comments.
 */
export declare function safeScriptWithArgs(templateObj: TemplateStringsArray, ...emptyArgs: ReadonlyArray<''>): (...argValues: ReadonlyArray<Serializable | null>) => SafeScript;
export {};
