...
exports.sanitizeHtmlToFragment = exports.sanitizeHtmlAssertUnchanged = exports.sanitizeHtml = exports.serializeSrcset = exports.parseSrcset = exports.HtmlSanitizerImpl = void 0;
require("../../environment/dev.js");
const pure_js_1 = require("../../internals/pure.js");
const secrets_js_1 = require("../../internals/secrets.js");
const html_builders_js_1 = require("../html_builders.js");
const url_builders_js_1 = require("../url_builders.js");
const css_isolation_js_1 = require("./css/css_isolation.js");
const inert_fragment_js_1 = require("./inert_fragment.js");
const no_clobber_js_1 = require("./no_clobber.js");
const resource_url_policy_js_1 = require("./resource_url_policy.js");
...
class HtmlSanitizerImpl {
    ...
    sanitize(html) {
        ...
        return (0, html_builders_js_1.nodeToHtmlInternal)(this.sanitizeToFragmentInternal(html, inertDocument), inertDocument.body);
    }
    ...
    sanitizeWithCssToFragment(htmlWithCss, inertDocument) {
        ...
        internalStyle.textContent = css_isolation_js_1.CSS_ISOLATION_STYLESHEET;
    ...
    sanitizeToFragmentInternal(html, inertDocument) {
        const dirtyFragment = (0, inert_fragment_js_1.createInertFragment)(html, inertDocument);
        ...
        while (currentNode !== null) {
            let sanitizedNode;
            if ((0, no_clobber_js_1.isText)(currentNode)) {
            ...
            else if ((0, no_clobber_js_1.isElement)(currentNode)) {
    ...
    sanitizeElementNode(elementNode, inertDocument) {
        const elementName = (0, no_clobber_js_1.getNodeName)(elementNode);
        ...
        for (const { name, value } of dirtyAttributes) {
            ...
            switch (policy.policyAction) {
                case sanitizer_table_js_1.AttributePolicyAction.KEEP:
                    setAttribute(newNode, name, value);
                    break;
                case sanitizer_table_js_1.AttributePolicyAction.KEEP_AND_SANITIZE_URL:
                    const sanitizedAttrUrl = (0, url_builders_js_1.restrictivelySanitizeUrl)(value);
                    ...
                    break;
                case sanitizer_table_js_1.AttributePolicyAction.KEEP_AND_NORMALIZE:
                    // We don't consider changing the case of an attribute value to be a
                    // semantic change
                    setAttribute(newNode, name, value.toLowerCase());
                    break;
                case sanitizer_table_js_1.AttributePolicyAction.KEEP_AND_SANITIZE_STYLE:
                    ...
                    break;
                case sanitizer_table_js_1.AttributePolicyAction.KEEP_AND_USE_RESOURCE_URL_POLICY:
                    if (this.resourceUrlPolicy) {
                        const hints = {
                            type: resource_url_policy_js_1.ResourceUrlPolicyHintsType.HTML_ATTRIBUTE,
                            attributeName: name,
                            elementName,
                        };
                        const url = (0, resource_url_policy_js_1.parseUrl)(value);
                    ...
                    break;
                case sanitizer_table_js_1.AttributePolicyAction.KEEP_AND_USE_RESOURCE_URL_POLICY_FOR_SRCSET:
                    if (this.resourceUrlPolicy) {
                        const hints = {
                            type: resource_url_policy_js_1.ResourceUrlPolicyHintsType.HTML_ATTRIBUTE,
                            attributeName: name,
                        ...
                        for (const part of srcset.parts) {
                            const url = (0, resource_url_policy_js_1.parseUrl)(part.url);
                            const sanitizedUrl = this.resourceUrlPolicy(url, hints);
                            if (sanitizedUrl) {
                    ...
                    break;
                case sanitizer_table_js_1.AttributePolicyAction.DROP:
    ...
    nodeFilter(node) {
        if ((0, no_clobber_js_1.isText)(node)) {
            return 1; // NodeFilter.FILTER_ACCEPT
        }
        else if (!(0, no_clobber_js_1.isElement)(node)) {
        ...
        const nodeName = (0, no_clobber_js_1.getNodeName)(node);
        if (nodeName === null) {
...
const defaultHtmlSanitizer = /* #__PURE__ */ (0, pure_js_1.pure)(() => new HtmlSanitizerImpl(default_sanitizer_table_js_1.DEFAULT_SANITIZER_TABLE, secrets_js_1.secretToken));
