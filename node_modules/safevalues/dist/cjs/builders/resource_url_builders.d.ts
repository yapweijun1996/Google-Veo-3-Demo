 ...
 */
declare type IterableEntries<U> = ReadonlyMap<string, U> | ReadonlyArray<[string, U]> | Readonly<Record<string, U>>;
declare type SearchParams = IterableEntries<Primitive | null | undefined | ReadonlyArray<Primitive | null | undefined>> | URLSearchParams;
/**
 ...
 * array.
 */
export declare function replaceParams(trustedUrl: TrustedResourceUrl, params: SearchParams): TrustedResourceUrl;
/**
 ...
 * array.
 */
export declare function appendParams(trustedUrl: TrustedResourceUrl, params: SearchParams): TrustedResourceUrl;
/**
 ...
 */
export declare function replaceFragment(trustedUrl: TrustedResourceUrl, fragment: string): TrustedResourceUrl;
/**
 ...
 */
export declare function appendPathSegment(trustedUrl: TrustedResourceUrl, pathSegment: string): TrustedResourceUrl;
/**
 ...
 */
export declare function toAbsoluteResourceUrl(pathRelativeUrl: TrustedResourceUrl): TrustedResourceUrl;
export {};
